...
shinyServer(function(input, output, session)
{
  ...
  rval_mes_1A <- reactiveValues(data="NULL")
  rval_mes_2A <- reactiveValues(data="NULL")
  rval_mes_3A <- reactiveValues(data="NULL")
  rval_mes_3A_Plot <- reactiveValues(data="NULL")
  rval_mes_4A <- reactiveValues(data="NULL")
  rval_mes_4A_Plot <- reactiveValues(data="NULL")
  rval_mes_5A <- reactiveValues(data="NULL")
  rval_mes_6AI <- reactiveValues(data="NULL")
  rval_mes_6ApV <- reactiveValues(data="NULL")
  rval_mes_6AVO <- reactiveValues(data="NULL")
  rval_mes_6APH <- reactiveValues(data="NULL")
  rval_mes_6AE <- reactiveValues(data="NULL")
  rval_mes_6AXC <- reactiveValues(data="NULL")
  rval_mes_6AN <- reactiveValues(data="NULL")
  rval_mes_6AM <- reactiveValues(data="NULL")
  rval_mes_6AI_core <- reactiveValues(data="NULL")
  rval_mes_6ApV_core <- reactiveValues(data="NULL")
  rval_mes_6AVO_core <- reactiveValues(data="NULL")
  rval_mes_6APH_core <- reactiveValues(data="NULL")
  rval_mes_6AE_core <- reactiveValues(data="NULL")
  rval_mes_6AXC_core <- reactiveValues(data="NULL")
  rval_mes_6AN_core <- reactiveValues(data="NULL")
  rval_mes_6AM_core <- reactiveValues(data="NULL")
  
  rval_mes_1B <- reactiveValues(data="NULL")
  rval_mes_2B <- reactiveValues(data="NULL")
  rval_mes_2B_Plot <- reactiveValues(data="NULL")
  rval_mes_3B <- reactiveValues(data="NULL")
  rval_mes_3B_Plot <- reactiveValues(data="NULL")
  rval_mes_4B <- reactiveValues(data="NULL")
  rval_mes_5BI <- reactiveValues(data="NULL")
  rval_mes_5BpV <- reactiveValues(data="NULL")
  rval_mes_5BVO <- reactiveValues(data="NULL")
  rval_mes_5BPH <- reactiveValues(data="NULL")
  rval_mes_5BE <- reactiveValues(data="NULL")
  rval_mes_5BXC <- reactiveValues(data="NULL")
  rval_mes_5BN <- reactiveValues(data="NULL")
  rval_mes_5BM <- reactiveValues(data="NULL")
  rval_mes_5BI_core <- reactiveValues(data="NULL")
  rval_mes_5BpV_core <- reactiveValues(data="NULL")
  rval_mes_5BVO_core <- reactiveValues(data="NULL")
  rval_mes_5BPH_core <- reactiveValues(data="NULL")
  rval_mes_5BE_core <- reactiveValues(data="NULL")
  rval_mes_5BXC_core <- reactiveValues(data="NULL")
  rval_mes_5BN_core <- reactiveValues(data="NULL")
  rval_mes_5BM_core <- reactiveValues(data="NULL")
  
  rval_mes_1C <- reactiveValues(data="")
  rval_mes_2C <- reactiveValues(data="NULL")
  rval_mes_2C_Plot <- reactiveValues(data="NULL")
  rval_mes_3C <- reactiveValues(data="NULL")
  rval_mes_3C_Plot <- reactiveValues(data="NULL")
  rval_mes_4C <- reactiveValues(data="NULL")
  rval_mes_5CI <- reactiveValues(data="NULL")
  rval_mes_5CpV <- reactiveValues(data="NULL")
  rval_mes_5CVO <- reactiveValues(data="NULL")
  rval_mes_5CPH <- reactiveValues(data="NULL")
  rval_mes_5CE <- reactiveValues(data="NULL")
  rval_mes_5CXC <- reactiveValues(data="NULL")
  rval_mes_5CN <- reactiveValues(data="NULL")
  rval_mes_5CM <- reactiveValues(data="NULL")
  rval_mes_5CI_core <- reactiveValues(data="NULL")
  rval_mes_5CpV_core <- reactiveValues(data="NULL")
  rval_mes_5CVO_core <- reactiveValues(data="NULL")
  rval_mes_5CPH_core <- reactiveValues(data="NULL")
  rval_mes_5CE_core <- reactiveValues(data="NULL")
  rval_mes_5CXC_core <- reactiveValues(data="NULL")
  rval_mes_5CN_core <- reactiveValues(data="NULL")
  rval_mes_5CM_core <- reactiveValues(data="NULL")
